    ...
    $.widget('mage.quickSearch', {
        ...
        _onSubmit: function (e) {
            ...
            if (this.responseList.selected) {
                ...
                this.element.attr(this.options.dataRef, this.responseList.selected.attr(this.options.dataRef));
                this.updateNovaPostData(this.responseList.selected);
            }
        },

        updateNovaPostData: function (selectedElement = false) {
            if (selectedElement) {
                switch (this.element.attr('name')) {
                    case 'city':
                        ...
                        break;
                    case 'street[0]':
                        novaPostModel.streetName(selectedElement.find('.qs-option-name').text());
                        break;
                    default:
                        return false;
                }
        ...
        _onKeyDown: function (e) {
            ...
            switch (keyCode) {
                ...
                case $.ui.keyCode.ENTER:
                    if (this.element.val().length >= parseInt(this.options.minSearchLength, 10) && this.responseList.selected) {
                        e.preventDefault();
                        this.responseList.selected.trigger('click');
                    }
                    break;
